// задать двумерный массив. Найти элементы, у которых обе позиции четные и заменить эти элементы на их квадраты
...
Array2dPrint(arr);
Console.WriteLine("Changed 2d array: ");
Array2dPrint(Changed2dArray(arr));
